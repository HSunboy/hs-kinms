    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.dispose();
				...
				cm.gainItem(1113057, 1);//绝对指环
				cm.gainItem(3015051, 1);//巨无霸飞机
				cm.gainItem(1012173, 1);//鬼娃娃150
				cm.gainItem(1142175,50,50,50,50,2000,2000,50,60,300,300,50,50,15,15);//冒险岛收藏家
				cm.gainItem(5150040, 50);//皇家
				cm.gainMeso(20000000);
            cm.sendOk("换购成功！");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]领取了天成冒险岛 800元累计充值答谢礼包！感谢您的支持！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
