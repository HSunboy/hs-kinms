 ...
 */
public class KinMS extends javax.swing.JFrame {
    ...
    private void 重启服务器() {
        try {
			...
			return;
                        ...
                        World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(0, "本私服器將在 " + minutesLeft + "分鐘後關閉. 請盡速關閉雇佣商人 並下線.").getBytes());;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KinMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
