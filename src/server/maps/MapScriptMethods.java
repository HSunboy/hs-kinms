...
public class MapScriptMethods {
    ...
    private static final String[] mulungEffects = {
        "我一直在等你！如果你有勇气，你会走在那个门的右边！",
        "勇敢的你如何成功的通过武陵道场!",
        "我会确保你会后悔来到了武陵道场！",
        "我喜欢你的勇气！但不要把你的勇气变成鲁莽！",
        "如果你想一步一步地走到成功的道路上，用一切方法去做！"};
    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case StageMsg_davy: {
                ...
                if (c.getPlayer().getMapId() == 925100500 && em != null && em.getProperty("stage5") != null && c.getChannelServer().getMapFactory().getMap(925100500).getNumMonsters() == 0) {
